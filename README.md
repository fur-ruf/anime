...
Визуальный браузер аниме с уникальным интерфейсом и плавной навигацией. 
...
## Важно знать
- Слайдеры лучше всего работают в Chrome/Edge (полная поддержка колеса мыши)
- API имеет ограничение: ~60 запросов в минуту
- Для поиска нужно ввести минимум 2 символа
